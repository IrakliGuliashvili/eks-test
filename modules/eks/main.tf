...
# IAM OIDC Provider for the cluster - needed for service accounts
...
# CloudWatch Logs policy for Fargate pods
resource "aws_iam_policy" "fargate_cloudwatch_logs" {
  name        = "${var.cluster_name}-fargate-cloudwatch-logs"
  description = "Policy for Fargate pods to send logs to CloudWatch"
